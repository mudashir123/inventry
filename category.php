            ...
            <div class="modal-body">
                <form class="user" method="post" action="" id="myForm">
                    ...
                    <div class="form-group">
                        <label for="bname">Category Name</label>
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Manage <span class="text-s font-weight-bold text-primary mb-1">Category</span>
    </h1>
</div>
<div class="row">
...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12">
        <button class="btn btn-primary btn-user" data-toggle="modal" data-target="#myModal">Add Category </button>
    </div>
</div><br>
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12">
...
$(document).ready(function() {
    ...
    $('#dtable').DataTable({
        ...
        "ajax": "operation/datatable/category.php",
    ...
    $("#submit").click(function(e) {
        ...
        saveData(form, 'operation/save/category.php');
    });
    $(document).on("click", '#btnDelete', function() {
        var jid = $(this).attr("data-id");
        deleteData(jid, 'operation/delete/category.php')
    });
