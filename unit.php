...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Manage <span class="text-s font-weight-bold text-primary mb-1">Units</span></h1>
</div>
<div class="row">
...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12">
        <button class="btn btn-primary btn-user" data-toggle="modal" data-target="#myModal">Add Units </button>
    </div>
</div><br>
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Manage Units</h6>
            </div>
            <div class="card-body">
...
$(document).ready(function() {
    ...
    $('#dtable').DataTable({
        ...
        "ajax": "operation/datatable/unit.php",
    ...
    $("#submit").click(function(e) {
        ...
        saveData(form, 'operation/save/unit.php');
    });
    $(document).on("click", '#btnDelete', function() {
        var jid = $(this).attr("data-id");
        deleteData(jid, 'operation/delete/unit.php')
    });
